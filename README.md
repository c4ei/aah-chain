...
현재 버전은 `0.8.2`이며, `0.8.1`의 실제 BFT 확정·인증서 동기화 기반에
자동 빌드 검증을 추가한 폐쇄형 테스트넷 단계입니다. 자세한 내용은
`docs/end/20260728_v0.0.8.2_BUILD_CI_STABILIZATION.md`를 참고하세요.
...
현재 버전은 `0.8.2`이며, 자동 부트스트랩 연결, 4노드 BFT 확정, 인증서 동기화,
