# IEUM Chain v0.20.3 쉬운 실행 안내

설치, systemd, 백업, 자동 업데이트 등 전체 운영 방법은
[`docs/USER_MANUAL_0.19.9.md`](docs/USER_MANUAL_0.19.9.md)에 정리되어 있으며,
v0.20.3 NAT·릴레이·홀 펀칭 변경 내용은
[`docs/VERSION_0.20.3.md`](docs/VERSION_0.20.3.md)를 참고하세요.
...
```bash
tar -xJf ieum-chain_node_ubuntu_x86_64_v0.20.3.tar.xz
cd ieum-chain-node-v0.20.3
sudo ./install.sh
```
...
scripts/deploy-node-package.sh \
  download/ieum-chain_node_ubuntu_x86_64_v0.20.3.tar.xz \
  dev@192.168.1.148
```
