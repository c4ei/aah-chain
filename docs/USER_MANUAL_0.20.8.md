...
v0.20.8 설치 패키지는 서명에 사용한 공개키가 들어 있는 활성
...
git commit -m "IEUM v0.20.8 signed release"
git push
```
...
v0.20.8 패키지를 최초 한 번 설치해야 합니다. 이후부터는 수동 설치가
필요하지 않습니다.
...
v0.20.8은 검증자 자동 등록 결과를 저장할 때 프로세스마다 고유한 임시 파일을
